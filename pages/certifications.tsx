    ...
    <div className="divide-y divide-gray-200 dark:divide-gray-700">
      ...
      >
        <motion.div
          ...
          className=" mx-4 flex flex-wrap items-center  justify-center   gap-8 sm:mx-16"
          ref={ref}
        >
          {[...certificationsData].map((cert, index) => (
            <motion.div
              ...
              className={`flex w-full max-w-[500px] rotate-0 scale-100 flex-col  overflow-hidden rounded-lg border-4 border-gray-900  p-4 transition-all  duration-200 dark:border-white ${
